...
def main_biascorrection(
    ...
    if fdays.size != ftime.size:
        e_tot = convert2daily(E, ftime, nsteps_per_day=24/dt, fagg="sum")
        p_tot = convert2daily(P, ftime, nsteps_per_day=24/dt, fagg="sum")
        h_tot = convert2daily(H, ftime, nsteps_per_day=24/dt, fagg="mean")
    else:
        e_tot = E
        p_tot = P
        h_tot = H
